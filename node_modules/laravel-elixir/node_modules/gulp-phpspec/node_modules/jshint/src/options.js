...
exports.bool = {
  enforcing: {
     ...
     * loop and conditionals. JavaScript allows you to omit curly braces when
    ...
    /**
     * This option requires all `for in` loop to filter object's items. The
     ...
     *     }
     *
     * For more in-depth understanding of `for in` loop in JavaScript, read
     * [Exploring JavaScript for-in
     * loop](http://javascriptweblog.wordpress.com/2011/01/04/exploring-javascript-for-in-loop/)
     * by Angus Croll.
     */
    forin       : true,
  ...
  relaxing: {
    ...
    */
    ...
    /**
     * This option suppresses warnings about functions inside of loop.
     * Defining functions inside of loop can lead to bugs such as this one:
     *
     *     var nums = [];
     *
     *     for (var i = 0; i < 10; i++) {
