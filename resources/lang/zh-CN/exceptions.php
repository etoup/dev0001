...
return [
    ...
    */
    ...
    'backend' => [
        ...
        'loop' => [
            'tags_already_exists' => '已经存在相同类别，请更换',
            'authority_already_exists' => '已经存在相同权限，请更换',
            'msg-destroy-error' => '消息删除失败',
            'destroy-error' => '圈子删除失败'
        ],
        'goods' => [
            'destroy-error' => '商品删除失败'
        ],
        'orders'=> [
            'destroy-error' => '订单删除失败',
            'store-error' => '订单编辑失败'
        ]
    ],
