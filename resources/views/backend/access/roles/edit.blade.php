...
@section('content')
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_1" data-toggle="tab">{{ trans('labels.backend.access.roles.edit') }}</a></li>
            <li class="pull-right">
        ...
        <div class="box-footer clearfix">
            <div class="pull-left">
                <a href="{!! route('admin.access.roles.index') !!}" class="btn btn-danger">{{ trans('buttons.general.cancel') }}</a>
            </div>
