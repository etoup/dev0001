...
@section('content')
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_1" data-toggle="tab">{{ trans('labels.backend.access.users.edit') }}</a></li>
        </ul>
        ...
        <div class="box-footer">
            ...
            <div class="pull-right">
                <input type="submit" class="btn btn-success" value="{{ trans('buttons.general.crud.update') }}" />
            </div>
        </div>
        @if ($user->id == 1)
