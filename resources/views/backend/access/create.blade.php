...
@section('content')
    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            <li class="active"><a href="#tab_1" data-toggle="tab">{{ trans('labels.backend.access.users.create') }}</a></li>
        </ul>
        ...
        <div class="box-footer">
            <div class="pull-left">
                <a href="{{route('admin.access.users.index')}}" class="btn btn-danger">{{ trans('buttons.general.cancel') }}</a>
            </div>

            <div class="pull-right">
                <input type="submit" class="btn btn-success" value="{{ trans('buttons.general.crud.create') }}" />
            </div>
        </div>
        {!! Form::close() !!}
    </div>
