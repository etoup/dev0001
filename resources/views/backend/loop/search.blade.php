...
@section('content')
    <div class="box">
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('title', request('title', $default = null), ['class' => 'form-control', 'placeholder' => '填写圈子名称']) !!}
                    </div>
                </div>
                <div class="col-lg-3 col-xs-3">
                    <div class="form-group">
                        {!! Form::label('name', '圈主用户名') !!}
                        {!! Form::text('name', request('name', $default = null), ['class' => 'form-control', 'placeholder' => '填写圈主用户名']) !!}
                    </div>
                </div>
                <div class="col-lg-3 col-xs-3">
                    <div class="form-group">
                        {!! Form::label('loops_tags_id', '圈子类别') !!}
                        <select name="loops_tags_id" class="form-control select2">
                            <option value="" selected="selected">全部</option>
                            @foreach($tags as $k => $v)
                                @if($k == request('loops_tags_id'))
        ...
        <div class="box-footer">
            <a href="{{ route('admin.loop') }}" class="btn btn-warning pull-left">
