            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">{{trans('strings.backend.dashboard.hello')}} {{ access()->user()->name }}</span>
                    </a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="{!! access()->user()->picture !!}" class="img-circle" alt="User Image" />
                            <p>
                                {!! access()->user()->name !!} - {{ trans('roles.administrator') }}
                                <small>{{ access()->user()->created_at }}</small>
                            </p>
                        </li>
                        <!-- Menu Body -->
                        <li class="user-body">
                            <div class="col-xs-4 text-center">
                                <a href="#">{{trans('strings.backend.links.account')}}</a>
                            </div>
                            <div class="col-xs-4 text-center">
                                <a href="#">{{trans('strings.backend.links.integral')}}</a>
                            </div>
                            <div class="col-xs-4 text-center">
                                <a href="#">{{trans('strings.backend.links.message')}}</a>
                            </div>
                        </li>
                        <!-- Menu Footer-->
